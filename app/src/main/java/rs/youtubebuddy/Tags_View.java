  ...
  android.content.DialogInterface.OnClickListener
{
  ...
  public Db db;
  public java.util.ArrayList<Tag> objs;
  ...
  public Tags_View(android.content.Context ctx, Db db)
  {
    super(ctx);
  ...
  public void Notify_Dataset_Changed()
  {
    ...
    {
      this.objs=(java.util.ArrayList<Tag>)
        this.db.Select_Objs
          (Tag.class, "select * from Tag where video_id=? order by millis asc", 
